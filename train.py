...
class FashionMNIST():
    ...
    def __init__(self,data_path='./fashion',batch_size=10,input_dt=(28,28,1),
                 classes=10,log_dir='./log/000/',feature_size=2048,metrics_save_path='./result'):
    ...
    def generate_Data(self):
        ...
        while 1:
            next_x,next_y=self.mnist.train.next_batch(self.batch_size)
            yield next_x,next_y
    ...
    def get_Examples(self):
        return self.mnist.train.images.shape[0],self.mnist.test.images.shape[0]
    ...
    def calu_Accuracy(self):
        ...
        fw_perf = open(self.save_path + '/index1.txt', 'w')
